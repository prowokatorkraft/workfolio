...
<template>
  <!--      <div class="skills-row">
        ...
        <div class="skills-items">
          <span
            v-for="skill in techStacks.frontend"
            :key="skill.name"
            class="skill-badge"
            :style="{
      ...
      <div class="skills-row">
        <span class="skills-label">Backend:</span>
        <div class="skills-items">
          <span
            v-for="skill in techStacks.backend"
            :key="skill.name"
            class="skill-badge"
            :style="{
              background: `linear-gradient(90deg, ${getLevelColor(skill.level)} ${
      ...
      <div class="skills-row">
        ...
        <div class="skills-items">
          <span
            v-for="skill in techStacks.database"
            :key="skill.name"
            class="skill-badge"
            :style="{
              background: `linear-gradient(90deg, ${getLevelColor(skill.level)} ${
      ...
      <div class="skills-row">
        ...
        <div class="skills-items">
          <span
            v-for="skill in techStacks.other"
            :key="skill.name"
            class="skill-badge"
            :style="{
              background: `linear-gradient(90deg, ${getLevelColor(skill.level)} ${
