...
const initialSkills: Technology[] = [
  { id: 1, name: 'Vue3', level: 50, group: TechnologyGroup.frontend },
  { id: 2, name: 'React', level: 50, group: TechnologyGroup.frontend },
  { id: 3, name: 'TypeScript', level: 60, group: TechnologyGroup.language },
  { id: 4, name: 'JavaScript', level: 80, group: TechnologyGroup.language },
  ...
  { id: 14, name: 'Docker', group: TechnologyGroup.tools },
  { id: 15, name: 'GitLab', level: 90, group: TechnologyGroup.tools },
  { id: 17, name: 'Jest', level: 70, group: TechnologyGroup.tools },
  { id: 18, name: 'JIRA', group: TechnologyGroup.tools },
  ...
  { id: 22, name: 'ActiveMQ', group: TechnologyGroup.none },
  ...
  { id: 27, name: 'C#', level: 100, group: TechnologyGroup.language },
  { id: 28, name: 'Web Forms', level: 50, group: TechnologyGroup.backend },
  { id: 29, name: 'ExtJS', level: 60, group: TechnologyGroup.frontend },
  { id: 30, name: 'Visual Basic', level: 30, group: TechnologyGroup.language },
  { id: 31, name: 'Works', group: TechnologyGroup.tools },
  { id: 32, name: 'Микросервисы', group: TechnologyGroup.none },
  { id: 33, name: 'Монолит', group: TechnologyGroup.none },
  { id: 34, name: '.NET Core', level: 80, group: TechnologyGroup.backend },
  { id: 35, name: 'Razor', level: 50, group: TechnologyGroup.backend },
  { id: 36, name: 'Kafka', group: TechnologyGroup.none },
  { id: 37, name: 'Redmine', group: TechnologyGroup.tools },
  { id: 38, name: 'Nx', group: TechnologyGroup.none },
  { id: 39, name: 'Java', level: 45, group: TechnologyGroup.language },
  ...
  { id: 43, name: 'SVN', level: 70, group: TechnologyGroup.tools },
  { id: 44, name: 'AI', level: 60, group: TechnologyGroup.none },
  { id: 45, name: 'Legacy Code', level: 50, group: TechnologyGroup.none },
  { id: 46, name: 'CI/CD', group: TechnologyGroup.tools },
  { id: 47, name: 'Jenkins', group: TechnologyGroup.tools },
  { id: 48, name: 'Kubernetes', group: TechnologyGroup.tools },
  { id: 49, name: 'Scrum', level: 50, group: TechnologyGroup.methodology },
  { id: 50, name: 'Kanban', level: 80, group: TechnologyGroup.methodology },
  { id: 51, name: 'NUnit', level: 60, group: TechnologyGroup.backend },
];
